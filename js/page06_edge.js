...
(function (compId) {
                    ...
                    dom: [
                        {
                            ...
                            fill: ["rgba(0,0,0,0)",im+"page7-asset1.png",'0px','0px']
                        },
                        {
                            id: 'page1-asset1',
                            type: 'image',
                            rect: ['1012px', '330px', '21px', '44px', 'auto', 'auto'],
    ...
    if (!window.edge_authoring_mode) AdobeEdge.getComposition(compId).load("page06_edgeActions.js");
})("EDGE-768282051");
