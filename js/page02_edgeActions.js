...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${page1-asset1}", "click", function(sym, e) {
         window.open("page04.html","_self")
      ...
      Symbol.bindElementAction(compId, symbolName, "${page3-asset2}", "click", function(sym, e) {
