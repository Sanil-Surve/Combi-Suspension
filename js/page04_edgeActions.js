...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${page2-asset2}", "click", function(sym, e) {
         window.open("page02.html","_self")

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${page5-asset1}", "click", function(sym, e) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${page5-asset2}", "click", function(sym, e) {
         window.open("page05.html","_self")
         

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${page5-asset3}", "click", function(sym, e) {
